...
G & & \textrm{The number of components present in the global context (if applicable).} \\
...
c &= (c_1, \ldots, c_N) & \textrm{The global allocation vector (if applicable).} \\
\pi_l &= (\pi_{l1,}\ldots, \pi_{lK_l}) & \textrm{The mixture weights in the $lth$ context.} %\\
\pi &= (\pi_1, \ldots, \pi_G) & \textrm{The mixutre weights for the global components (if present).}
\end{eqnarray}
