...
This is the _base case_ which most of the other scenarios are some variation of. This is intended to be a benchmark against which performance may be judged. 
...
This is to test how distinct the clusters must be for the inference to perform well. 
...
This is to test the _small $N$, large $P$_ scenario so common in genetics.
...
This is to test how robust to noise the methods are.
...
This simulation is designed ot test how sensitive the methods are to relatively small clusters when large clusters are present.
