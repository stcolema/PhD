...
In comparison to Frequentist inference, this approach has some strong advantages. 
...
3. As mentioned previously, one may incorporate prior beliefs into the inference and thus may apply Bayesian methods even when the samples size is small.
...
In summary, Bayesian inference is very powerful, over coming many of the issues that Frequentist methods have, but retain some weaknesses. Primarily, MCMC methods can be slow and may have problems with multiple modes.
