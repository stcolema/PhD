...
\begin{aligned}
L &= \begin{bmatrix}
  l_{01} & l_{11} & \cdots & l_{K1} \\
  \vdots & \vdots & \ddots & \vdots \\
  l_{0p} & l_{1p} & \cdots & l_{Kp}
\end{bmatrix} \\
...
iCluster aims to reduce the dimensionality of the problem. To do this an additional matrix, $\Gamma$ is included. $\Gamma$ has the form $diag(1, \gamma_j, \ldots, \gamma_j)$. The inclusion of a constant 1 in both $\Gamma$ and $F$ allows an intercept value of $l_{01}$. $\gamma_j$ 

<!-- \[ -->
<!-- X_l = \Gamma_l \beta_l Z + \epsilon  -->
<!-- %x_{lij} = z_i \Gamma_{lj} \beta_{lj} + \epsilon_{lij} -->
<!-- \] -->

Where $Z$ is the factors matrix, and 
