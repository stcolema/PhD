...
One can see that if $\gamma_j=0$ that the feature is loaded only through the intercept value of $l_{j0}$, whereas if $\gamma_j=1$ the remaining terms are included.
